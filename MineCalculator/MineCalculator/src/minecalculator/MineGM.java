...
public class MineGM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        openingBracket.setBackground(new java.awt.Color(153, 153, 153));
        openingBracket.setFont(new java.awt.Font("URW Bookman", 0, 24)); // NOI18N
        openingBracket.setForeground(new java.awt.Color(0, 0, 204));
        openingBracket.setText("(");
        openingBracket.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        closingBracket.setBackground(new java.awt.Color(153, 153, 153));
        closingBracket.setFont(new java.awt.Font("URW Bookman", 0, 24)); // NOI18N
        closingBracket.setForeground(new java.awt.Color(0, 0, 204));
        closingBracket.setText(")");
        closingBracket.setToolTipText("");
        closingBracket.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(openingBracket, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(closingBracket, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(openingBracket, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(closingBracket, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void equalToBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_equalToBtnActionPerformed
        ...
        for(int i=0;i<txt.length();i++)
        {
            ...
            if(Character.isDigit(ch)){
                ...
                if(sb.length()>0){
                    val.push(Integer.valueOf(sb.toString()));
                    sb.setLength(0);
                }
                if(op.isEmpty()|| ch=='(' || op.peek()=='('){
                     ...
                     while(op.peek()!='('){
                        ...
                        if(op.peek()=='*'){val.push(val1*val2);}
                        if(op.peek()=='/'){
                            try{val.push(val1/val2);}catch(Exception e){}}
                        op.pop();   
                    }
                    op.pop();
                }else{
    ...
    private void closingBracketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_closingBracketActionPerformed
        // TODO add your handling code here:
        appendToTextField(closingBracket.getText());
    ...
    private void openingBracketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openingBracketActionPerformed
        // TODO add your handling code here:
        appendToTextField(openingBracket.getText());
